...
export default function ShareDropdown({ url, title, className = '' }: ShareDropdownProps) {
  ...
  const shareTitle = title || 'PenseMed - Locação de Equipamentos Médicos';
  ...
  const handleWhatsAppShare = () => {
    const message = `Confira este produto: ${shareTitle}\n${shareUrl}`;
